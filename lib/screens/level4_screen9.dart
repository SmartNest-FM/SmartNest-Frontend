...
class Level4Screen9 extends StatefulWidget {
  const Level4Screen9({super.key});

  @override
  State<Level4Screen9> createState() => _Level4Screen9State();
}

class _Level4Screen9State extends State<Level4Screen9> {
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='los niños están en la clase' || answerRecorder =='los niños estan en la clase'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
