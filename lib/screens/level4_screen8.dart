...
class Level4Screen8 extends StatefulWidget {
  const Level4Screen8({super.key});

  @override
  State<Level4Screen8> createState() => _Level4Screen8State();
}

class _Level4Screen8State extends State<Level4Screen8> {
  ...
  void initState() {
    super.initState();
    _loadUserData();
    fetchCombinationReadingImages(8);
    fetchFeedback(8);
    requestPermissions();
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='la vaca está en el campo' || answerRecorder =='la vaca esta en el campo'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
