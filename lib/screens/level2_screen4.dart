...
class Level2Screen4 extends StatefulWidget {
  const Level2Screen4({super.key});

  @override
  State<Level2Screen4> createState() => _Level2Screen4State();
}

class _Level2Screen4State extends State<Level2Screen4> {
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='volando' || answerRecorder =='lando'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
