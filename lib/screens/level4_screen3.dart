...
class Level4Screen3 extends StatefulWidget {
  const Level4Screen3({super.key});

  @override
  State<Level4Screen3> createState() => _Level4Screen3State();
}

class _Level4Screen3State extends State<Level4Screen3> {
  ...
  void initState() {
    super.initState();
    _loadUserData();
    fetchCombinationReadingImages(3);
    fetchFeedback(3);
    requestPermissions();
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='los niños están jugando' || answerRecorder =='los niños estan jugando'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
