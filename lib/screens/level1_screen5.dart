...
class Level1Screen5 extends StatefulWidget {
  const Level1Screen5({super.key});

  @override
  State<Level1Screen5> createState() => _Level1Screen5State();
}

class _Level1Screen5State extends State<Level1Screen5> {
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='platano' || answerRecorder =='plátano' || answerRecorder =='pltano'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
