...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  try {
    ...
    var getUserResponse = await http.get(Uri.parse(Api.userByUid(uid)));
    ...
    if (getUserResponse.statusCode == 200) {
      ...
      var updateUserResponse = await http.put(
        Uri.parse(Api.updateUser(int.parse(userId))),
      ...
      if (updateUserResponse.statusCode == 200) {
        ...
        var updatedUserResponse = await http.get(Uri.parse(Api.getUserById(int.parse(userId))));
