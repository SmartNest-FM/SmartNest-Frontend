...
class Level2Screen5 extends StatefulWidget {
  const Level2Screen5({super.key});

  @override
  State<Level2Screen5> createState() => _Level2Screen5State();
}

class _Level2Screen5State extends State<Level2Screen5> {
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='navegando' || answerRecorder =='gando'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
