...
class Level1Screen2 extends StatefulWidget {
  const Level1Screen2({super.key});

  @override
  State<Level1Screen2> createState() => _Level1Screen2State();
}

class _Level1Screen2State extends State<Level1Screen2> {
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='autobus' || answerRecorder =='autobús' || answerRecorder =='autobs'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
                  ...
                  children: [
                    ButtonPrimary2(
                      onPressed: (){
                        ...
                        fetchPhonologicalAwareness(2); // Volver a cargar la actividad
                        fetchFeedback(2); // Volver a cargar el feedback
                      },
                      text: 'Reintentar',
                    )
                  ],
