...
class Level4Screen2 extends StatefulWidget {
  const Level4Screen2({super.key});

  @override
  State<Level4Screen2> createState() => _Level4Screen2State();
}

class _Level4Screen2State extends State<Level4Screen2> {
  ...
  void initState() {
    super.initState();
    _loadUserData();
    fetchCombinationReadingImages(2);
    fetchFeedback(2);
    requestPermissions();
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='el gato está bebiendo leche' || answerRecorder =='el gato esta bebiendo leche'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
