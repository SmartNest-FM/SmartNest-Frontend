...
class Level2Screen3 extends StatefulWidget {
  ...
  @override
  State<Level2Screen3> createState() => _Level2Screen3State();
}

class _Level2Screen3State extends State<Level2Screen3> {
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='manejando' || answerRecorder =='jando'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
