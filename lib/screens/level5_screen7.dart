...
class Level5Screen7 extends StatefulWidget {
  const Level5Screen7({super.key});

  @override
  State<Level5Screen7> createState() => _Level5Screen7State();
}

class _Level5Screen7State extends State<Level5Screen7> {
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='columpiándose' || answerRecorder =='columpiandose' || answerRecorder =='columpindose'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
