...
class Level4Screen7 extends StatefulWidget {
  const Level4Screen7({super.key});

  @override
  State<Level4Screen7> createState() => _Level4Screen7State();
}

class _Level4Screen7State extends State<Level4Screen7> {
  ...
  void initState() {
    super.initState();
    _loadUserData();
    fetchCombinationReadingImages(7);
    fetchFeedback(7);
    requestPermissions();
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='el niño está leyendo un libro' || answerRecorder =='el niño esta leyendo un libro' ){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
