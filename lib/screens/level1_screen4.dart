...
class Level1Screen4 extends StatefulWidget {
  const Level1Screen4({super.key});

  @override
  State<Level1Screen4> createState() => _Level1Screen4State();
}

class _Level1Screen4State extends State<Level1Screen4> {
  ...
  void _initRecorder() async {
    try {
      await _soundRecorder.openRecorder();await _soundRecorder.openRecorder();
