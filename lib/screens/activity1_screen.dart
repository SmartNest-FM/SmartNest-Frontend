...
class ActivitiesScreen1 extends StatefulWidget {
  const ActivitiesScreen1({super.key});

  @override
  State<ActivitiesScreen1> createState() => _ActivitiesScreen1State();
}

class _ActivitiesScreen1State extends State<ActivitiesScreen1> {
