...
class Level3Screen7 extends StatefulWidget {
  const Level3Screen7({super.key});

  @override
  State<Level3Screen7> createState() => _Level3Screen7State();
}

class _Level3Screen7State extends State<Level3Screen7> {
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='mercancias' || answerRecorder == 'mercancía' || answerRecorder =='mercancías' || answerRecorder == 'mercancia'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
