...
class Level4Screen4 extends StatefulWidget {
  const Level4Screen4({super.key});

  @override
  State<Level4Screen4> createState() => _Level4Screen4State();
}

class _Level4Screen4State extends State<Level4Screen4> {
  ...
  void initState() {
    super.initState();
    _loadUserData();
    fetchCombinationReadingImages(4);
    fetchFeedback(4);
    requestPermissions();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: const Text('Actividad 4', style: TextStyle(color: Colors.white)),
