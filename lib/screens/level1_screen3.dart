...
class Level1Screen3 extends StatefulWidget {
  const Level1Screen3({super.key});

  @override
  State<Level1Screen3> createState() => _Level1Screen3State();
}

class _Level1Screen3State extends State<Level1Screen3> {
                  ...
                  children: [
                    ButtonPrimary2(
                      onPressed: (){
                        ...
                        fetchPhonologicalAwareness(3); // Volver a cargar la actividad
                        fetchFeedback(3); // Volver a cargar el feedback
                      },
                      text: 'Reintentar',
                    )
                  ],
