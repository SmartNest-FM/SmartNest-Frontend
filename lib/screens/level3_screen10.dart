...
class Level3Screen10 extends StatefulWidget {
  const Level3Screen10({super.key});

  @override
  State<Level3Screen10> createState() => _Level3Screen10State();
}

class _Level3Screen10State extends State<Level3Screen10> {
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='en el lago' || answerRecorder =='lago' || answerRecorder =='el lago'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
  ...
  Future<void> _showSuccessDialog() async {
    speak('¡Genial!, ¡Lo hiciste fantástico ${_user?.nameuser}!. Puedes iniciar con el nivel 4. ¡Exitos!');
