...
class Level2Screen10 extends StatefulWidget {
  const Level2Screen10({super.key});

  @override
  State<Level2Screen10> createState() => _Level2Screen10State();
}

class _Level2Screen10State extends State<Level2Screen10> {
  ...
  Future<void> _showSuccessDialog() async {
    speak('¡Genial!, ¡Lo hiciste fantástico ${_user?.nameuser}!. Puedes iniciar con el nivel 3. ¡Exitos!');
