...
class Level3Screen2 extends StatefulWidget {
  const Level3Screen2({super.key});

  @override
  State<Level3Screen2> createState() => _Level3Screen2State();
}

class _Level3Screen2State extends State<Level3Screen2> {
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='monedas de oro' || answerRecorder =='oro' || answerRecorder =='de oro' || answerRecorder =='monedas'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
