...
class Level4Screen10 extends StatefulWidget {
  const Level4Screen10({super.key});

  @override
  State<Level4Screen10> createState() => _Level4Screen10State();
}

class _Level4Screen10State extends State<Level4Screen10> {
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='la familia está cenando' || answerRecorder =='la familia esta cenando'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
  ...
  Future<void> _showSuccessDialog() async {
    speak('¡Genial!, ¡Lo hiciste fantástico ${_user?.nameuser}!. Puedes iniciar con el nivel 5. ¡Exitos!');
              ...
              Row(
                ...
                children: [
                  ...
                  child: IconButton(
                    ...
                    onPressed: () async{
                      await speak('En base a las imagenes presentadas. ${combinationReadingImagesModel?.question ?? ''}');
                    },
                  ),
                )
                ],
