...
class Level5Screen9 extends StatefulWidget {
  const Level5Screen9({super.key});

  @override
  State<Level5Screen9> createState() => _Level5Screen9State();
}

class _Level5Screen9State extends State<Level5Screen9> {
  ...
  Future<void> stopRecording() async {
      ...
      if (path != null) {
        ...
        if(answerRecorder =='recolectando'){
          _showSuccessDialog();
        }else{
          _showRetryDialog();
        }
