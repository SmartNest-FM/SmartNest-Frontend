...
class Level1Screen9 extends StatefulWidget {
  const Level1Screen9({super.key});

  @override
  State<Level1Screen9> createState() => _Level1Screen9State();
}

class _Level1Screen9State extends State<Level1Screen9> {
  ...
  void initState() {
    super.initState();
    _loadUserData();
    fetchPhonologicalAwareness(9); // Aquí cambia el ID si es necesario
  }
