...
class Level4Screen6 extends StatefulWidget {
  const Level4Screen6({super.key});

  @override
  State<Level4Screen6> createState() => _Level4Screen6State();
}

class _Level4Screen6State extends State<Level4Screen6> {
  ...
  void initState() {
    super.initState();
    _loadUserData();
    fetchCombinationReadingImages(6);
    fetchFeedback(6);
    requestPermissions();
